...
export default function SmokeCursor() {
  ...
  useEffect(() => {
    ...
    const render = (now: number) => {
      ...
      drawField(ctx, cloudA, t * 260, -t * 90, 1.45, 0.028);
      drawField(ctx, cloudB, -t * 170, t * 60, 1.05, 0.02);
      ...
      falloff.addColorStop(0.24, "rgba(255,255,255,0.82)");
      falloff.addColorStop(0.46, "rgba(255,255,255,0.4)");
      falloff.addColorStop(0.68, "rgba(255,255,255,0.14)");
      ...
      core.addColorStop(0, "rgba(252, 130, 80, 0.17)");
      core.addColorStop(0.45, "rgba(214, 52, 38, 0.07)");
